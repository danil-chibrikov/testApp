...
public class CustomResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler
    public final ResponseEntity<Object> handleAccountIdException(AccountIdException ex, WebRequest request) {
        AccountIdExceptionResponse exceptionResponse = new AccountIdExceptionResponse(ex.getMessage());
